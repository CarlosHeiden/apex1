...
from escola.serializers import AlunosSerialiazer, CursosSerializer, NotasSerialiazer
    ...
    def list(self, request):
        ...
        for nota in self.get_queryset():
            if nota.aluno.nome in media_notas:
                ...
                media_notas[nota.aluno.nome] = nota.nota
        media_notas = {k: round(v / len(self.get_queryset()), 2) for k, v in media_notas.items()}
